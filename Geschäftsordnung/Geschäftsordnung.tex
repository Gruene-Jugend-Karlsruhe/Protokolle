...
\item Wird eine weiche Quotierung gefordert, ist wie folgt zu verfahren: Einem männlichen
Redebeitrag hat ein weiblicher zu folgen. Möchte sich keine Frau äußern, wird ein weiterer
männlicher Beitrag ermöglicht.Menschen, die in einer Diskussion noch keinen Redebeitrag geleistet haben, sind bei der
Aufstellung der Redeliste zu bevorzugen. Diese Regelung tritt erst in Kraft, sobald eine
Person ein zweites Mal auf der Redeliste auftaucht.
\item Wird eine harte Quotierung gefordert, ist wie folgt zu verfahren: Einem männlichem
Redebeitrag hat ein weiblicher zu folgen. Findet sich keine Frau ist die Diskussion zu
beenden. Erstredner*innen sind bei der Aufstellung der Redeliste zu bevorzugen.
\end{absatz}
\section{}
\begin{absatz}
